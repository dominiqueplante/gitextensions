    ...
    public partial class FormBrowse : GitExtensionsForm
    {
        ...
        private void InternalInitialize(bool hard)
        {
            ...
            if (hasWorkingDir)
                ...
                ShowDashboard();
            InternalInitializeControlStateBasedOnValidWorkingDirectory(validWorkingDir);
        ...
        private void InternalInitializeControlStateBasedOnValidWorkingDirectory(bool validWorkingDir)
        {
        ...
        private void UserManualToolStripMenuItemClick(object sender, EventArgs e)
        {
            try
            {
                Process.Start(Path.Combine(Settings.InstallDirectory, "GitExtensionsUserManual.pdf"));
            }
            catch (Exception ex)
            {
                MessageBox.Show(this, ex.Message);
        ...
        {
            string fileName = Path.Combine(Settings.Module.WorkingDirectoryGitDIrectory, "index.lock");
        ...
        {
            var needRefresh = refreshNeeded(sender);
        ...
        private bool refreshNeeded(object sender)
        {
            bool needRefresh;
